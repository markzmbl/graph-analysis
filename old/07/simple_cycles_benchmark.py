...
edges = edges.sort_values(["current_time", "source", "target"])
graph = nx.from_pandas_edgelist(edges, create_using=nx.MultiDiGraph, edge_attr=True, edge_key="current_time")
